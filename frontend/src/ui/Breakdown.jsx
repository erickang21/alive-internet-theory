...
const CRITERIA = {
  ...
  elevenlabs_voice: {
    ...
    summary: (evidence, deduction) =>
      deduction > 0
        ? "An ElevenLabs voice was used in this video."
        : "Voice was not detected as being generated by ElevenLabs.",
    rows: (evidence) => [["Voice match", percent(evidence.probability)]],
    about: (
      <>
